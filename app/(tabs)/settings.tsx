...
export default function SettingsScreen() {
  return <View style={styles.container}><Text style={styles.title}>Settings</Text><Text style={styles.text}>Workspace configuration will be added after authentication.</Text></View>;
}
